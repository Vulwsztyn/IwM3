...
//   if (!idObs) res.render('patient.pug', { data: patient })
//   else {
//     let daneDoWykresu = []
...
//     res.render('observation.pug', { data: patient, observationIndex: idObs, graphData: daneDoWykresu })
//   }
// })
...
router.get('/', function(req, res) {
  // http://hapi.fhir.org/baseDstu3/Patient?name=Coy&_pretty=true
  
  // http://hapi.fhir.org/baseDstu3/Patient?_pretty=true
  res.send('POST route on things.')
})
